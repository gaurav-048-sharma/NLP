...
# Application: Text Sentiment Classification using LLM

from google import genai

# Create client using Gemini API key
client = genai.Client(api_key="AIzaSyA60gV4VCDxAKIlN-MDP9eH3Fecs9_TAUw")
